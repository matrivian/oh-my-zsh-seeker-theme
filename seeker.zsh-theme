...
%{$fg[yellow]%}%n%{$reset_color%}@%{$fg[yellow]%}%m%{$reset_color%}:%{$fg_bold[blue]%}%~%{$reset_color%} $(_pyenv_prompt_info)$(_rbenv_prompt_info)$(_git_prompt_info)$(_hg_prompt_info) % %{$reset_color%}
$(prompt_char) '
...
ZSH_THEME_PYENV_PROMPT_PREFIX="%{$fg_bold[red]%}pyenv:‹%{$fg[magenta]%}"
